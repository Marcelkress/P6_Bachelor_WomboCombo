...
#define LEDMoon_Place   53 // Specifik per controller 
#define LEDStar_Place   22 // specifik per controller
...
void sendPacket(int32_t rotationValue, uint8_t pushed) {
  ...
  strncpy(pkt.controllerName, "Controller 1", sizeof(pkt.controllerName) - 1);
